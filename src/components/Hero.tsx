      ...
      if (dis && rl > 0) {
        ...
        els.push(
          <span key={k++} className="relative inline">
            ...
            <span className="absolute -top-7 left-0 text-[11px] text-weak bg-weak/10 border border-weak/20 px-2 py-0.5 rounded whitespace-nowrap font-medium">
              {SWAPS[si].annotation}
            </span>
          </span>,
        );
      ...
      <div className="relative max-w-7xl mx-auto px-6 w-full py-14 md:py-20">
        ...
        <div className="flex flex-col lg:flex-row items-start gap-10 lg:gap-16">
          ...
          <div className="w-full lg:w-[62%]">
            <div className="bg-bg-alt/60 border border-white/[0.06] rounded-2xl p-6 md:p-10 min-h-[260px] shadow-2xl shadow-black/20">
              <div className="flex items-center gap-2 mb-6 pb-4 border-b border-white/[0.06]">
                <div className="w-3 h-3 rounded-full bg-[#FF5F57]" />
                <div className="w-3 h-3 rounded-full bg-[#FFBD2E]" />
                <div className="w-3 h-3 rounded-full bg-[#28CA41]" />
                <span className="ml-3 text-xs text-text-muted tracking-wide">
                  essay_draft_v2.txt
                </span>
              </div>
              {renderEssay()}
